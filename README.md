...
- notifications push activées uniquement après consentement, même page fermée : seuil réglable de retard, départ calculé selon la route vers l’aéroport et confirmation d’arrivée ;
- expiration stricte à 48 heures et nettoyage horaire ;
- stockage temporaire dans Netlify Blobs.

## Limite importante

Sans clé de fournisseur aérien commercial, le retard, l’arrivée et la durée sont des estimations transparentes : l’application combine l’heure prévue saisie par le créateur, la distance de la route et, en vol, la position et la vitesse ADS-B. Si le signal ADS-B est absent ou ancien, l’avion n’est pas localisé sur la carte et le rappel de départ ne se déclenche pas. Le calcul routier est une durée indicative fournie par OSRM, sans trafic automobile en direct. Ce ne sont pas des informations officielles de compagnie.
