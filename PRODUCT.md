...
- Le lien public affiche la route et place l’avion uniquement sur une position ADS-B récente du bon indicatif. En l’absence de signal fiable, il indique clairement que la position est inconnue et n’invente pas de mouvement.
...
- Les horaires calculés ne sont pas des informations officielles de compagnie ou d’aéroport.

## Sources

ADSBdb fournit la route et les aéroports, ADSB.lol fournit la position reçue des transpondeurs, et Open-Meteo fournit le fuseau horaire. Sans position ADS-B récente, la carte conserve la route mais pas de marqueur d’avion.
